...
public class PicFragmentAdapter extends RecyclerView.Adapter<PicFragmentAdapter.ViewHolder> {

    private List<PicEntity.DataBean> list;
    private OnRecyclerViewItemClickListener onItemClick;
    private PicEntity.DataBean dataBean;

    public PicFragmentAdapter(List list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        WeakReference<PicEntity.DataBean> weakReference = new WeakReference(list.get(position));
        dataBean = weakReference.get();
