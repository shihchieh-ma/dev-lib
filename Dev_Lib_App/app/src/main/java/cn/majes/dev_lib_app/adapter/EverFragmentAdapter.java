...
public class EverFragmentAdapter extends RecyclerView.Adapter<EverFragmentAdapter.ViewHolder> {

    private List<EverEntity.DataBean> list;
    private OnRecyclerViewItemClickListener onItemClick;

    public EverFragmentAdapter(List list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        WeakReference<EverEntity.DataBean> weakReference = new WeakReference(list.get(position));
        EverEntity.DataBean dataBean = weakReference.get();
