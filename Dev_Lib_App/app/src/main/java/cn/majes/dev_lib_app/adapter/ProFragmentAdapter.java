...
public class ProFragmentAdapter extends RecyclerView.Adapter<ProFragmentAdapter.ViewHolder> {

    private List<ProEntity.DataBean> list;
    private OnRecyclerViewItemClickListener onItemClick;

    public ProFragmentAdapter(List list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        WeakReference<ProEntity.DataBean> weakReference = new WeakReference(list.get(position));
        ProEntity.DataBean dataBean = weakReference.get();
